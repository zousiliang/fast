...
/**
 * Created by zousiliang on 19/9/1.
 */
@Configuration
public class ShardingConfig {
    ...
    public DataSource dataSource() throws SQLException{
        ...
        TableRuleConfiguration tableRuleConfig = priceRuleConfig();
        // 配置分片规则
     ...
     * @return
     */
    private TableRuleConfiguration priceRuleConfig() {
        // 配置user表规则
        TableRuleConfiguration tableRuleConfig = new TableRuleConfiguration();
        tableRuleConfig.setLogicTable("t_cut_price");
        tableRuleConfig.setActualDataNodes("ds${0..1}.t_cut_price${0..1}");
        //tableRuleConfig.setKeyGeneratorColumnName("id");
        // 配置分库 + 分表策略
        tableRuleConfig.setDatabaseShardingStrategyConfig(new InlineShardingStrategyConfiguration("created_by", "ds${Integer.valueOf(created_by).intValue() % 2}"));
        tableRuleConfig.setTableShardingStrategyConfig(new InlineShardingStrategyConfiguration("luck", "t_cut_price${Integer.valueOf(luck).intValue() % 2}"));
